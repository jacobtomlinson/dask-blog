...
_Note: This post is not user-focused. It is intended for library writers._
...
Steps 2 and 4 require symbolic analysis of _what_ work should be done; Blaze
does this well. Steps 1 and 3 are more about coordinating _where_ data goes
and _when_ computation executes.
...
_after_ we built our graph. The framework investment is very light.
