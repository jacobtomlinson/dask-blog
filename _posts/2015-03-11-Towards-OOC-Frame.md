...
_This post primarily targets developers. It is on experimental code that is
not ready for users._
...
Question: _Can we represent a large DataFrame as a sequence of in-memory DataFrames and
perform most Pandas operations using task scheduling?_

Answer: _I don't know. Lets try._
...
_Complex operations are easy if the logic aligns with the index_
...
common solutions in this field. If anything here looks suspicious then _please
speak up_. I could really use your help.
