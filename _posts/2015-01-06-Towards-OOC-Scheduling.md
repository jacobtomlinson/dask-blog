...
_Disclaimer 2: This post is technical and intended for people who care about
task scheduling, not for traditional users._
...
We failed to achieve this exactly (see note at bottom) but still, _in theory_,
we're great!
...
worker threads. This is the job of a _scheduler_.
...
_Select tasks that immediately free data resources on completion_
