...
_Disclaimer: technical comparisons are hard to do well. I am biased towards
Dask and ignorant of correct Celery practices. Please keep this in mind.
Critical feedback by Celery experts is welcome._
...
The question on my mind is now is _Can Dask be a useful solution in more
traditional loose task scheduling problems where projects like Celery are
typically used? What are the benefits and drawbacks?_
...
achieve the same results in a pinch. For each task you can _restrict_ the pool
...
Dask can handle Celery workloads, _if you're not diving into deep API_.
