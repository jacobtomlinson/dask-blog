...
_This post is about experimental software. This is not ready for public use.
All code examples and API in this post are subject to change without warning._
...
Streamz was designed to handle the _control flow_ of such a system, but did
...
probably a _worse_ solution than what we had before, just because it involves
